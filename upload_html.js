...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .section-title {
    ...
    color: #6366f1; margin-bottom: 16px; display: flex; align-items: center; gap: 8px;
  }
  ...
  .trend-card {
    ...
    border: 1px solid #e0e3ff; border-radius: 10px; padding: 16px;
...
// Upload HTML content directly via the upload-content API
// Since we can't write files, we'll use the upload API with base64 content
const content = Buffer.from(htmlContent, 'utf8');
const body = JSON.stringify({
  content: content.toString('base64'),
  filename: 'AI-Tech-Briefing-2026-03-23.html',
  mimeType: 'text/html',
...
const options = {
  hostname: '127.0.0.1',
  port: parseInt(PORT),
  path: '/proxy/qclaw-cos/upload-content',
  method: 'POST',
  headers: {
